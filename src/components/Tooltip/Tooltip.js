...
class Tooltip extends Component {
  constructor (props) {
    ...
    componentDidMount () {
      ...
      const wrapTitle = (title) => `<div class="blog-tooltip-inner" style="background: black; color: white; padding: 5px 4px; font-size: 12px; border-radius: 4px; opacity: .8">${title}</div>`;
